...
proteins=re.perm.all$feature[re.perm.all$p.emperical < 0.05] # 602
...
proteins=re.perm.05$feature[re.perm.05$p.emperical < 0.005] # 100
...
proteins=re.perm.005$feature[re.perm.005$p.emperical < 0.0005] # 19
...
1-qvalue(re.perm.all$p.emperical)$pi0 # 0.385
re.perm.all$q=qvalue(re.perm.all$p.emperical)$qvalues
sum(re.perm.all$q < 0.05)  # 5
sum(re.perm.all$q < 0.10)  # 64
sum(re.perm.all$q < 0.20)  # 503
max(re.perm.all$p.emperical[re.perm.all$q < 0.05]) #  .00008
max(re.perm.all$p.emperical[re.perm.all$q < 0.10]) # 0.0024
max(re.perm.all$p.emperical[re.perm.all$q < 0.20]) # 0.0381
